...
const getCurrentlyAffected = (data) => {
  ...
  impact.infectionsByRequestedTime = Math.trunc(impactEffect * (2 ** calculateFactor(data)));
  severeImpact.infectionsByRequestedTime = Math.trunc(severeEffect * (2 ** calculateFactor(data)));
